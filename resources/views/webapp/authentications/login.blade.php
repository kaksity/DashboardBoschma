...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="/app/app/assets/img/favicon/favicon.ico" />
            ...
            <div class="app-brand justify-content-center">
              <a href="" class="app-brand-link gap-2">
                <span class="app-brand-logo demo">
                  <img width="100" src="/app/imgs/logo.png" alt="logo" />
                </span>
                <div class="mt-3">
                  <h4>
                    <b>BOSCHMA
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="email" name="email_address"
                  value="{{ old('email_address') }}" placeholder="Enter your email address" autofocus />
                @error('email_address')
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" name="remember_me" for="remember-me"> Remember Me </label>
                </div>
              </div>
              <div class="mb-3">
