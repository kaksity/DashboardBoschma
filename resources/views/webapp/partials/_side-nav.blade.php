<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="" class="app-brand-link gap-2">
        <span class="app-brand-logo demo">
          <img width="60" src="/app/imgs/logo.png" alt="logo" />
        </span>
        <div class="mt-3">
          <h4>
            <b>BOSCHMA
    ...
    <ul class="menu-inner py-1">
      <!-- Dashboard -->
      <li class="menu-item">
        <a href="{{ route('webapp.dashboards.index') }}" class="menu-link">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('webapp.enrollments.create') }}" class="menu-link">
              <div data-i18n="Basic">Upload</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{ route('webapp.enrollments.index') }}" class="menu-link">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('webapp.news.create') }}" class="menu-link">
              <div data-i18n="Basic">Create</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{ route('webapp.news.index') }}" class="menu-link">
              <div data-i18n="Basic">View</div>
            </a>
          </li>
        </ul>
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('webapp.messages.index') }}" class="menu-link">
              <div data-i18n="Basic">View</div>
            </a>
          </li>
        </ul>
